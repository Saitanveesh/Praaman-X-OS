...
export default function Bridge() {
  ...
  return <div className="space-y-4 text-zinc-200">
    <section className="rounded border border-amber-700/60 bg-amber-950/20 p-4 text-sm text-amber-100">
      Stage 1.1 is simulation-only. No real MAVLink hardware command execution is enabled.
    </section>
    ...
    <section className="rounded border border-zinc-800 bg-zinc-950 p-4">
      ...
      <p className="mt-3 text-xs text-zinc-500">Future secure mode is a placeholder for later PUFShield integration and is not active in Stage 1.1.</p>
    </section>
  </div>;
}
...
function descriptionFor(mode: C2ConnectionMode) {
  ...
  return 'Future PUFShield-secure control placeholder; not active in Stage 1.1.';
}
