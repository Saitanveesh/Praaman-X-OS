...
export interface SITLReadiness { status: string; read_only: boolean; command_sending_enabled: boolean; expected_host: string; expected_port: number; telemetry_source: string; mavlink_provider_status: string; mission_planner_role: string; pramaanx_role: string; checklist: string[]; warnings: string[]; recommended_next_step: string; }
